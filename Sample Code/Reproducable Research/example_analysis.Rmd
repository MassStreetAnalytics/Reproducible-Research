...
output:
  ...
  pdf_document: defaultb #Actually won't knit to PDF on my machine
---
...
pm0 <- read.table("../../Data/reproduceable_research/RD_501_88101_1999-0.txt", comment.char = "#", 
...
pm1 <- read.table("../../Data/reproduceable_research/RD_501_88101_2012-0.txt", comment.char = "#", 
